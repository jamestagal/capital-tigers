...
<div class="page-content bg-white">
  ...
  <div
    ...
    style="background-image:url(media/images/banner/2022-AFL-Richmond-Tigers-Banner.jpeg);"
  >
    <div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div>
            <h2 class="m-t30 m-b10">SPORTS TECHNIQUES</h2>
            <p>
                ...
                <div class="dez-box">
                  ...
                  <div class="dez-info p-a30 bg-gray">
                    ...
                    <p>
                      ...
                      rorem ipsum dolor consectetur Fusce varius [...]
                    </p>
        ...
        <div class="col-lg-3">
          <div class="icon-bx-wraper bx-style-1 p-a30 center m-b15">
            <div class="icon-bx-sm text-primary bg-white radius border-2 m-b20">
              <a href="." class="icon-cell"><i class="fa fa-user"></i></a>
            </div>
          ...
          <div class="icon-bx-wraper bx-style-1 p-a30 center m-b15">
            <div class="icon-bx-sm text-primary bg-white radius border-2 m-b20">
              <a href="." class="icon-cell"><i class="fa fa-building-o"></i></a>
            </div>
            <div class="icon-content">
              <h5 class="dez-tilte text-uppercase">Recent Highlights</h5>
              <p>
          ...
          <div class="icon-bx-wraper bx-style-1 p-a20 left">
            <div class="icon-bx-xs text-primary bg-white radius border-2">
              <a href="." class="icon-cell"><i class="fa fa-code"></i></a>
            </div>
            <div class="icon-content">
